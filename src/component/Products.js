...
function Products() {
  return (
    <>
      <div>
        <div className='text-[16.32px] text-[#666666] font-[700] leading-[19px] font-[Karla] mt-[42px] ml-[30px] uppercase title pb-[4px] mb-[5px]'>
          PRODUCTS
        </div>
        <div className='bg-[#DEE8F1] ml-[30px] mr-[30px] relative mb-[33px]'>
          ...
          <h3 className='font-[Karla] text-[24px] leading-[30px] text-[#8D8D8D] font-[800] pl-[12px] mb-[12px] sh'>
        ...
        <div className='bg-[#C4C4C4AD] ml-[30px] mr-[30px] relative mb-[33px] pb-[36.19px]'>
          ...
          <h3 className='font-[Karla] text-[20px] leading-[30px] text-[#8D8D8D] font-[800] pl-[12px] mb-[12px] sh'>
          ...
          <div className='mt-[22px]'>
            <input
              className='w-[160.47px] h-[37.81px] ml-[12px] rounded-[7px] drop-shadow-2xl font-[Karla] text-[#1974C44A] placeholder:text-[11px] pl-[8px]'
              type='text'
              placeholder='Enter your email address'
            />
            <button className='h-[31px] w-[81px] rounded-[7px] ml-[14.53px] text-[11px] font-[Karla] font-[400] '>
              Get Started
            </button>
          </div>
        </div>
